...
本项目的 Backbone 依赖 DINOv3 官方源码，需克隆到项目根目录：

```bash
git clone https://github.com/facebookresearch/dinov3.git dinov3-main
```

并将 DINOv3 预训练权重 `dinov3_vits16_pretrain.pth` 放置于项目根目录。
